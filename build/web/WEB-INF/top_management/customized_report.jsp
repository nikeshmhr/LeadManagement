                    ...
                    <div class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Generate Active Leads Report</h2>
                                    ...
                                    <div class="x_content">
                                        <form action="/LeadManagement/top_management/reports/customized" method="POST">
                                            Counsellor: <select name="counsellorId" required>
                                                <option value="0">Select Counsellor</option>
                                                <c:forEach var="counsellor" items="${counsellors}">
                                                    <option value="<c:out value='${counsellor.id}' />"><c:out value="${counsellor.name}" /></option>
                                                </c:forEach>
                                            </select>
                                            ...
                                            Start: <input type="date" name="startDate" required/> - End: <input type="date" name="endDate" required/>
                                                ...
                                                <tbody>
                                                    <c:forEach var="leads" items="${listOfLeads}">
                                                        <tr class="even pointer">
                                                            ...
                                                            <td><c:out value="${leads.phone}" /></td>
                                                            <td><c:out value="${leads.dateOfBirth}" /></td>
                                                            <td><c:out value="${leads.dateOfEntry}" /></td> 
                                                            <td><c:out value="${leads.faculty.facultyName}" /></td>
                                                            <td class=" last">
