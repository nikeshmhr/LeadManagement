...
<html lang="en">
    ...
    <head>
        ...
        <script type="text/javascript">
            function checkNotification() {
                var xmlhttp;
                var url = "/LeadManagement/counsellor/notification";
            ...
            function checkNotificationForFollowup() {
                var xmlhttp;
                var url = "/LeadManagement/counsellor/notfication/followup";
                if (window.XMLHttpRequest)
                {
                    xmlhttp = new XMLHttpRequest();
                }
                ...
                xmlhttp.onreadystatechange = function ()
                {
                    if (xmlhttp.readyState == 4 && xmlhttp.status == 200)
                    {
                        document.getElementById("count1").innerHTML = xmlhttp.responseText;
                    }
                }
    ...
    <body class="nav-md" onmousemove="checkNotification();checkNotificationForFollowup();" onload="checkNotification();checkNotificationForFollowup();">
                                ...
                                <ul class="nav side-menu">
                                    <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu" style="display: none">
                                            <li><a href="/LeadManagement/counsellor/dashboard">Dashboard (<span id="count">0</span>)</a> 
                                            </li>
                                            <li><a href="/LeadManagement/counsellor/lead/followupToday">List of NEW Leads for you today (<span id="count1">0</span>)</a>
                                            </li> 
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>List of Total Leads under you</h2>
                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach var="lead" items="${leads}">
                                                    ...
                                                    <tr class="even pointer">
                                                        <td class=" ">
                                                            <a href="#<c:out value='${lead.id}' />"data-toggle="modal">
                                                                <u><c:out value="${lead.name}" /></u>
                                                            </a>
                                                        </td>
