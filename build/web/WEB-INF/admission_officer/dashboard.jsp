...
<html lang="en">
    ...
    <body class="nav-md" onmousemove="runAjaxForNotification();" onload="runAjaxForNotification();">
                                ...
                                <ul class="nav side-menu">
                                    <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu" style="display: none">
                                            <li><a href="/LeadManagement/admission_officer/leadsToAdmit">Leads to admit (<span id="count">0</span>)</a>
                                            </li>
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <div class="col-md-8 col-lg-8 col-sm-7">
                                            ...
                                            <!-- blockquote -->
                                            <blockquote>
                                                <p>Hello, <%out.print(c.getNameForId());%>! Welcome to your dashboard! You can navigate through the navigation bar in the side bar!</p><span class = "glyphicon glyphicon-arrow-left"></span>
                                            </blockquote>
