                    ...
                    <div class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Generate Counsellor Report</h2>
                                    ...
                                    <div class="x_content">
                                        <form action="/LeadManagement/top_management/reports/counsellor" method="POST">
                                                ...
                                                <tbody>
                                                    <c:forEach var="leads" items="${listOfLeads}">
                                                        <tr class="even pointer">
                                                            ...
                                                            <td><c:out value="${leads.status.statusName}" /></td>
                                                            <td><c:out value="${leads.dateOfEntry}" /></td>
                                                            <td class=" last">
                                                                <c:out value="${leads.semester}" />
                                                            </td>
                                                        </tr>
